...
\footnotetext{Cometent un anacronisme greu, es deixa una nota pel lector del present per
  compendre millor d'on surt la relació. Sigui $x$ el segment sencer, i $y,z$ les parts, amb $x=y+z$ i $y > z$.
  L'enunciat busca els $y,z$ que fan que $y^2 = x \cdot z \Longleftrightarrow \frac{x}{y} = \frac{y}{z}$. Queda per tant
  vist que tant l'enunciat d'Euclides com aquest alternatiu són equivalents.}
